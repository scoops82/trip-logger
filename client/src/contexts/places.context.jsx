...
export const PlacesProvider = (props) => {
  ...
  const { loading, error, places, loaded } = state;
  ...
  const updatePlace = useCallback(
    async (id, updates) => {
      ...
      try {
        ...
        console.log(
          "🚀 ~ file: places.context.js ~ line 95 ~ updatePlace ~ oldPlace",
          oldPlace
        );
        ...
        console.log(
          "🚀 ~ file: places.context.js ~ line 99 ~ updatePlace ~ newPlace",
          newPlace
        );
        ...
        console.log(
          "🚀 ~ file: places.context.js ~ line 120 ~ updatedPlaces",
          updatedPlaces
        );
