...
export const UsersProvider = (props) => {
  ...
  const { loading, error, users, loaded } = state;
  ...
  const updateUser = useCallback(
    async (id, updates) => {
      ...
      try {
        ...
        console.log(
          "🚀 ~ file: users.context.js ~ line 95 ~ updateUser ~ oldUser",
          oldUser
        );
        ...
        console.log(
          "🚀 ~ file: users.context.js ~ line 99 ~ updateUser ~ newUser",
          newUser
        );
        ...
        console.log(
          "🚀 ~ file: users.context.js ~ line 120 ~ updatedUsers",
          updatedUsers
        );
